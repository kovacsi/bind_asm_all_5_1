...
@interface x_org_objectweb_asm_commons_RemappingClassAdapter : NSObject
+ (x_org_objectweb_asm_commons_RemappingClassAdapter*) valueWithClassVisitorWithRemapper:(id) arg0 :(id) arg1;
