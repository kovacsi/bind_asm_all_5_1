...
@interface LocalVariablesSorter : NSObject

+ (LocalVariablesSorter*)valueWithInt:(int)arg0 withString:(NSString*)arg1 withMethodVisitor:(id)arg2;
...
- (int)newLocalWithType:(Type*)arg0;
