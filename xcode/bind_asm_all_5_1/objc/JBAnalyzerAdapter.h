...
@interface JBAnalyzerAdapter : NSObject

+ (JBAnalyzerAdapter*)valueWithString:(NSString*)arg0 withInt:(int)arg1 withString:(NSString*)arg2 withString:(NSString*)arg3 withMethodVisitor:(id)arg4;
