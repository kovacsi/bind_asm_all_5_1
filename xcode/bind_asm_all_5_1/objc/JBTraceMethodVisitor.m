#import "JBTraceMethodVisitor.h"

@implementation JBTraceMethodVisitor

+ (JBTraceMethodVisitor*)valueWithPrinter:(id)arg0 {
	return nil;
}

+ (JBTraceMethodVisitor*)valueWithMethodVisitor:(id)arg0 withPrinter:(id)arg1 {
	return nil;
}
