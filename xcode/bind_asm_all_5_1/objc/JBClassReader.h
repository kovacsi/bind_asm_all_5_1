...
@interface JBClassReader : NSObject

+ (JBClassReader*)valueWithByte:(id)arg0;
+ (JBClassReader*)valueWithByte:(id)arg0 withInt:(int)arg1 withInt:(int)arg2;
- (int)getAccess;
- (NSString*)getClassName;
- (NSString*)getSuperName;
- (id)getInterfaces;
+ (JBClassReader*)valueWithInputStream:(id)arg0;
+ (JBClassReader*)valueWithString:(NSString*)arg0;
