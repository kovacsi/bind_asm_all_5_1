#import "JBCheckMethodAdapter.h"

@implementation JBCheckMethodAdapter

+ (JBCheckMethodAdapter*)valueWithMethodVisitor:(id)arg0 {
	return nil;
}

+ (JBCheckMethodAdapter*)valueWithMethodVisitor:(id)arg0 withMap:(id)arg1 {
	return nil;
}

+ (JBCheckMethodAdapter*)valueWithInt:(int)arg0 withString:(NSString*)arg1 withString:(NSString*)arg2 withMethodVisitor:(id)arg3 withMap:(id)arg4 {
	return nil;
}
