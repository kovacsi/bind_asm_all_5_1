...
@interface RemappingMethodAdapter : NSObject

+ (RemappingMethodAdapter*)valueWithInt:(int)arg0 withString:(NSString*)arg1 withMethodVisitor:(id)arg2 withRemapper:(id)arg3;
