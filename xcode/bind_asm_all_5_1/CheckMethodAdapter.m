#import "CheckMethodAdapter.h"

@implementation CheckMethodAdapter

+ (CheckMethodAdapter*)valueWithMethodVisitor:(id)arg0 {
	return nil;
}

+ (CheckMethodAdapter*)valueWithMethodVisitor:(id)arg0 withMap:(id)arg1 {
	return nil;
}

+ (CheckMethodAdapter*)valueWithInt:(int)arg0 withString:(NSString*)arg1 withString:(NSString*)arg2 withMethodVisitor:(id)arg3 withMap:(id)arg4 {
	return nil;
}
