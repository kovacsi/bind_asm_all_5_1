...
@interface org_objectweb_asm_util_CheckClassAdapter : NSObject

+ (void)mainWithString:(id)arg0;
+ (void)verifyWithClassReader:(org_objectweb_asm_ClassReader*)arg0 withClassLoader:(id)arg1 withBoolean:(bool)arg2 withPrintWriter:(id)arg3;
+ (void)verifyWithClassReader:(org_objectweb_asm_ClassReader*)arg0 withBoolean:(bool)arg1 withPrintWriter:(id)arg2;
