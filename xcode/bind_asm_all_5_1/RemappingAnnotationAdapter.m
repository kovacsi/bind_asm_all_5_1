#import "RemappingAnnotationAdapter.h"

@implementation RemappingAnnotationAdapter

+ (RemappingAnnotationAdapter*)valueWithAnnotationVisitor:(id)arg0 withRemapper:(id)arg1 {
	return nil;
}
