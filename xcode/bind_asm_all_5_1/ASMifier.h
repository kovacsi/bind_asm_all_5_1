...
- (void)visitMethodEnd;
- (ASMifier*)visitAnnotationWithString:(NSString*)arg0 withBoolean:(bool)arg1;
- (ASMifier*)visitTypeAnnotationWithInt:(int)arg0 withTypePath:(TypePath*)arg1 withString:(NSString*)arg2 withBoolean:(bool)arg3;
- (ASMifier*)visitTypeAnnotationWithString:(NSString*)arg0 withInt:(int)arg1 withTypePath:(TypePath*)arg2 withString:(NSString*)arg3 withBoolean:(bool)arg4;
