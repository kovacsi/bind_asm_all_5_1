...
@interface org_objectweb_asm_tree_MethodNode : NSObject

+ (org_objectweb_asm_tree_MethodNode*)value;
+ (org_objectweb_asm_tree_MethodNode*)valueWithInt:(int)arg0;
+ (org_objectweb_asm_tree_MethodNode*)valueWithInt:(int)arg0 withString:(NSString*)arg1 withString:(NSString*)arg2 withString:(NSString*)arg3 withString:(id)arg4;
+ (org_objectweb_asm_tree_MethodNode*)valueWithInt:(int)arg0 withInt:(int)arg1 withString:(NSString*)arg2 withString:(NSString*)arg3 withString:(NSString*)arg4 withString:(id)arg5;
