#import "org_objectweb_asm_tree_ClassNode.h"

@implementation org_objectweb_asm_tree_ClassNode

+ (org_objectweb_asm_tree_ClassNode*)value {
	return nil;
}

+ (org_objectweb_asm_tree_ClassNode*)valueWithInt:(int)arg0 {
	return nil;
}
