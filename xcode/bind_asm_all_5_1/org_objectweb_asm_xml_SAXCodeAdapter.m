#import "org_objectweb_asm_xml_SAXCodeAdapter.h"

@implementation org_objectweb_asm_xml_SAXCodeAdapter

+ (org_objectweb_asm_xml_SAXCodeAdapter*)valueWithSAXAdapter:(org_objectweb_asm_xml_SAXAdapter*)arg0 withInt:(int)arg1 {
	return nil;
}
