#import "x_org_objectweb_asm_commons_MethodRemapper.h"

@implementation x_org_objectweb_asm_commons_MethodRemapper

+ (x_org_objectweb_asm_commons_MethodRemapper*) valueWithMethodVisitorWithRemapper:(id) arg0 :(id) arg1 {
	return nil;
}
