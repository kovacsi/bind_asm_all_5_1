...
public class SourceInterpreter extends NSObject {
	...
	public org.objectweb.asm.tree.analysis.SourceValue copyOperationWithIdWithId(org.objectweb.asm.tree.AbstractInsnNode arg0, org.objectweb.asm.tree.analysis.SourceValue arg1) {
		return original.copyOperation(arg0, arg1);
	}

	@Selector("unaryOperationWithIdWithId::")
	public org.objectweb.asm.tree.analysis.SourceValue unaryOperationWithIdWithId(org.objectweb.asm.tree.AbstractInsnNode arg0, org.objectweb.asm.tree.analysis.SourceValue arg1) {
		return original.unaryOperation(arg0, arg1);
	}

	@Selector("binaryOperationWithIdWithIdWithId:::")
	public org.objectweb.asm.tree.analysis.SourceValue binaryOperationWithIdWithIdWithId(org.objectweb.asm.tree.AbstractInsnNode arg0, org.objectweb.asm.tree.analysis.SourceValue arg1, org.objectweb.asm.tree.analysis.SourceValue arg2) {
		return original.binaryOperation(arg0, arg1, arg2);
	}

	@Selector("ternaryOperationWithIdWithIdWithIdWithId::::")
	public org.objectweb.asm.tree.analysis.SourceValue ternaryOperationWithIdWithIdWithIdWithId(org.objectweb.asm.tree.AbstractInsnNode arg0, org.objectweb.asm.tree.analysis.SourceValue arg1, org.objectweb.asm.tree.analysis.SourceValue arg2, org.objectweb.asm.tree.analysis.SourceValue arg3) {
		return original.ternaryOperation(arg0, arg1, arg2, arg3);
	}

	@Selector("returnOperationWithIdWithIdWithId:::")
	public void returnOperationWithIdWithIdWithId(org.objectweb.asm.tree.AbstractInsnNode arg0, org.objectweb.asm.tree.analysis.SourceValue arg1, org.objectweb.asm.tree.analysis.SourceValue arg2) {
		original.returnOperation(arg0, arg1, arg2);
	}

	@Selector("mergeWithIdWithId::")
	public org.objectweb.asm.tree.analysis.SourceValue mergeWithIdWithId(org.objectweb.asm.tree.analysis.SourceValue arg0, org.objectweb.asm.tree.analysis.SourceValue arg1) {
