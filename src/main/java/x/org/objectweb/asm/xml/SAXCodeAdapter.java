...
@ObjCClassName("org_objectweb_asm_xml_SAXCodeAdapter")
@RegisterOnStartup
@com.intel.moe.natj.general.ann.Runtime(ObjCRuntime.class)
public class SAXCodeAdapter extends NSObject {	
	
	public org.objectweb.asm.xml.SAXCodeAdapter original;	
	...
	public SAXCodeAdapter value(org.objectweb.asm.xml.SAXAdapter arg0, int arg1) {		
