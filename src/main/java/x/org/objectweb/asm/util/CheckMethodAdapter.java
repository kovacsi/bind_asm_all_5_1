...
public class CheckMethodAdapter extends NSObject {
	...
	public CheckMethodAdapter valueWithId(org.objectweb.asm.MethodVisitor arg0) {
	...
	public CheckMethodAdapter valueWithIdWithId(org.objectweb.asm.MethodVisitor arg0, java.util.Map arg1) {
		CheckMethodAdapter self = (CheckMethodAdapter) CheckMethodAdapter.alloc().init();
		self.original = new org.objectweb.asm.util.CheckMethodAdapter(arg0, arg1);
		return self;
	}

	@Selector("valueWithIntWithStringWithStringWithIdWithId:::::")
	public CheckMethodAdapter valueWithIntWithStringWithStringWithIdWithId(int arg0, String arg1, String arg2, org.objectweb.asm.MethodVisitor arg3, java.util.Map arg4) {
		CheckMethodAdapter self = (CheckMethodAdapter) CheckMethodAdapter.alloc().init();
