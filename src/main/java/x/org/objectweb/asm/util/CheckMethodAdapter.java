...
@ObjCClassName("JBCheckMethodAdapter")
@RegisterOnStartup
@com.intel.moe.natj.general.ann.Runtime(ObjCRuntime.class)
public class CheckMethodAdapter extends NSObject {	
	
	public org.objectweb.asm.util.CheckMethodAdapter original;	
	...
	@Owned	
	@Selector("alloc")	
	public static native CheckMethodAdapter alloc();	
	
	@Selector("valueWithMethodVisitor:")	
	public CheckMethodAdapter valueWithMethodVisitor(Object arg0) {
		CheckMethodAdapter self = (CheckMethodAdapter) CheckMethodAdapter.alloc().init();		
		self.original = new org.objectweb.asm.util.CheckMethodAdapter((org.objectweb.asm.MethodVisitor) arg0);		
		return self;		
	}	
	
	@Selector("valueWithMethodVisitor:withMap:")	
	public CheckMethodAdapter valueWithMethodVisitorwithMap(Object arg0, java.util.Map arg1) {
		CheckMethodAdapter self = (CheckMethodAdapter) CheckMethodAdapter.alloc().init();		
		self.original = new org.objectweb.asm.util.CheckMethodAdapter((org.objectweb.asm.MethodVisitor) arg0, arg1);		
		return self;		
	}	
	
	@Selector("valueWithInt:withString:withString:withMethodVisitor:withMap:")	
	public CheckMethodAdapter valueWithIntwithStringwithStringwithMethodVisitorwithMap(int arg0, String arg1, String arg2, Object arg3, java.util.Map arg4) {
		CheckMethodAdapter self = (CheckMethodAdapter) CheckMethodAdapter.alloc().init();		
		self.original = new org.objectweb.asm.util.CheckMethodAdapter(arg0, arg1, arg2, (org.objectweb.asm.MethodVisitor) arg3, arg4);		
		return self;		
	}	
