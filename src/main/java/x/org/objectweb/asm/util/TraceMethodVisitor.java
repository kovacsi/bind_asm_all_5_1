...
public class TraceMethodVisitor extends NSObject {
	...
	public TraceMethodVisitor valueWithId(org.objectweb.asm.util.Printer arg0) {
	...
	public TraceMethodVisitor valueWithIdWithId(org.objectweb.asm.MethodVisitor arg0, org.objectweb.asm.util.Printer arg1) {
		TraceMethodVisitor self = (TraceMethodVisitor) TraceMethodVisitor.alloc().init();
