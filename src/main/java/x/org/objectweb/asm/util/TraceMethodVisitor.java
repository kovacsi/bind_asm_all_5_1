...
@ObjCClassName("x_org_objectweb_asm_util_TraceMethodVisitor")
@RegisterOnStartup
@com.intel.moe.natj.general.ann.Runtime(ObjCRuntime.class)
public class TraceMethodVisitor extends NSObject {

	private org.objectweb.asm.util.TraceMethodVisitor original;
	...
	public TraceMethodVisitor valueWithPrinter(org.objectweb.asm.util.Printer arg0) {
		TraceMethodVisitor self = (TraceMethodVisitor) TraceMethodVisitor.alloc().init();
		self.original = new org.objectweb.asm.util.TraceMethodVisitor(arg0);
		return self;
	}

	@Selector("valueWithMethodVisitorWithPrinter::")
	public TraceMethodVisitor valueWithMethodVisitorWithPrinter(org.objectweb.asm.MethodVisitor arg0, org.objectweb.asm.util.Printer arg1) {
		TraceMethodVisitor self = (TraceMethodVisitor) TraceMethodVisitor.alloc().init();
		self.original = new org.objectweb.asm.util.TraceMethodVisitor(arg0, arg1);
		return self;
	}
