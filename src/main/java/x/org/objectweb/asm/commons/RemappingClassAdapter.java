...
@ObjCClassName("JBRemappingClassAdapter")
@RegisterOnStartup
...
public class RemappingClassAdapter extends NSObject {	
	...
	@Owned	
	@Selector("alloc")	
	public static native RemappingClassAdapter alloc();	
	
	@Selector("valueWithClassVisitor:withRemapper:")	
	public RemappingClassAdapter valueWithClassVisitorwithRemapper(Object arg0, Object arg1) {
		RemappingClassAdapter self = (RemappingClassAdapter) RemappingClassAdapter.alloc().init();		
		self.original = new org.objectweb.asm.commons.RemappingClassAdapter((org.objectweb.asm.ClassVisitor) arg0, (org.objectweb.asm.commons.Remapper) arg1);		
		return self;		
	}	
