...
@ObjCClassName("JBMethodRemapper")
@RegisterOnStartup
@com.intel.moe.natj.general.ann.Runtime(ObjCRuntime.class)
public class MethodRemapper extends NSObject {	
	
	public org.objectweb.asm.commons.MethodRemapper original;	
	...
	@Owned	
	@Selector("alloc")	
	public static native MethodRemapper alloc();	
	
	@Selector("valueWithMethodVisitor:withRemapper:")	
	public MethodRemapper valueWithMethodVisitorwithRemapper(Object arg0, Object arg1) {
		MethodRemapper self = (MethodRemapper) MethodRemapper.alloc().init();		
		self.original = new org.objectweb.asm.commons.MethodRemapper((org.objectweb.asm.MethodVisitor) arg0, (org.objectweb.asm.commons.Remapper) arg1);		
		return self;		
	}	
